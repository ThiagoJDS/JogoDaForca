...
function ocultaPalavra(){
    ...
    exibePalavraOcultada(palavraOcultada);
}

function exibePalavraOcultada(palavra){
...
function atualizaPalavraInterface(letra){
    ...
    exibePalavraOcultada(palavraAux);
}
